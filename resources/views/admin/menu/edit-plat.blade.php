...
@section('title', 'Éditer Plat')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Éditer le Plat</h1>
    <p class="text-gray-600">Modifier les informations du plat</p>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2">
        <form method="POST" action="{{ route('admin.menu.plats.update', $plat) }}">
            @csrf
            @method('PUT')
            ...
            <div class="card">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nom" name="nom" value="{{ old('nom', $plat->nom) }}" 
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="prix" name="prix" value="{{ old('prix', $plat->prix) }}" 
                               class="input" required step="0.01" min="0">
                    </div>

                    <div>
                        <label for="quantite" class="label">Quantité *</label>
                        <input type="number" id="quantite" name="quantite" value="{{ old('quantite', $plat->quantite) }}" 
    ...
    <div>
        <div class="card sticky top-6">
            ...
            <div class="space-y-2 text-sm">
                <p class="text-gray-600"><strong>ID:</strong> {{ $plat->idPlats }}</p>
